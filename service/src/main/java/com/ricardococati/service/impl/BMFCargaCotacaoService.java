...
import com.ricardococati.repository.dao.IEmpresaAtivoDAO;
...
public class BMFCargaCotacaoService implements IBMFCargaCotacaoService {
  ...
  private final IEmpresaAtivoDAO empresaAtivoDAO;
