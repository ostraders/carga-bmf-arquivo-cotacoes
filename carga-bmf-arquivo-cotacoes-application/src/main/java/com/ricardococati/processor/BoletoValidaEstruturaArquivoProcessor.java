...
public class BoletoValidaEstruturaArquivoProcessor implements ItemProcessor<FieldSet, BoletoDTO>{
	...
	private void validarTipagemDosCampos(String nomeCampo, String valorCampo, BoletoUtil boletoUtil) throws Exception, LinhaInvalidaException {
		...
		try {
			...
			integrationService.setArquivoValido(false);
			String mensagemErro = "Ocorreu um erro ao validar o " + "LAYOUT " + boletoUtil.getTipoRegistro() + " Campo " + nomeCampo + " Numerico : ";
	...
	private class BoletoUtil {
		...
		public void validaInclusaoExclusaoBoleto(BoletoUtil boletoUtil) throws Exception, LinhaInvalidaException {
	    ...
	    public void validaTipoPagtoBoleto(BoletoUtil boletoUtil) throws Exception, LinhaInvalidaException {
